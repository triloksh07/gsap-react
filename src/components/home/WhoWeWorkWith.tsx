...
export const WhoWeWorkWith: React.FC = () => {
    ...
    return (
        <section className="work-section h-[70vh] py-24 border-t border-white/5 bg-dark">
            <div className="max-w-7xl mx-auto px-4 text-center">
                <h2 className="reveal-up font-heading text-4xl md:text-[5rem] lg:text-[6.5rem] leading-[0.85] uppercase tracking-tighter mb-16 opacity-0 text-white">
                    Who We<br />
                    <span
