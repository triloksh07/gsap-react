    ...
    return (
        <section className="services-section py-24 border-t border-white/5 overflow-hidden bg-dark">
            <div className="max-w-6xl mx-auto px-6">
                <h2 className="reveal-up opacity-0 font-mono font-extrabold text-4xl md:text-[4.5rem] leading-[1] uppercase tracking-tighter text-center mb-16">
                    Our Digital<br />
                    <span className="text-transparent" style={{ WebkitTextStroke: '1px white' }}>Services</span>
                </h2>
                <div className="flex flex-col border-t border-white/10">
                    {services.map((srv, i) => (
                        <div key={i} className="service-row opacity-0 py-8 border-b border-white/10 flex flex-col md:flex-row gap-6 md:gap-12 md:items-center hover:bg-white/[0.03] hover:pl-6 transition-all duration-300 px-4 cursor-pointer group">
